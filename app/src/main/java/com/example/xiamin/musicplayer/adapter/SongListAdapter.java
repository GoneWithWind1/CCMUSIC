        ...
        switch (itemType) {
            case TYPE_PROFILE: {
                ...
                if (view == null) {
                    ...
                    viewHolderProfile.tvProfile=(TextView)view.findViewById(R.id.tv_profile);
            ...
            case TYPE_MUSIC_LIST: {
                if (view == null) {
                    ...
                    viewHolderMusicList.ivCover=(ImageView)view.findViewById(R.id.iv_cover);
                    viewHolderMusicList.tvMusic1=(TextView)view.findViewById(R.id.tv_music_1);
                    viewHolderMusicList.tvMusic2=(TextView)view.findViewById(R.id.tv_music_2);
                    viewHolderMusicList.tvMusic3=(TextView)view.findViewById(R.id.tv_music_3);
                    viewHolderMusicList.vDivider=(View)view.findViewById(R.id.v_divider);
